...
import {IUseDragModalProps, IUseDragModalReturn} from './src/components/useDragModal'
import {IWaitProps, IWaitReturn} from './src/tools/useWait';
import {IUseLoadingReturn} from './src/tools/useLoading';
import {IUseWindowSizeReturn} from './src/tools/useWindowSize'
...
declare module "cover-hooks" {
  ...
  /** 等待过程控制 */
  export function useWait(props:IWaitProps):IWaitReturn
}
